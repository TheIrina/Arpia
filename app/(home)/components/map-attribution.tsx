    ...
    <>
      ...
      {isOpen && (
        <div
          role="button"
          tabIndex={0}
          className="fixed inset-0 bg-zinc-950/30 backdrop-blur-lg z-50 animate-in fade-in duration-200 "
      ...
      <div className="absolute top-4 right-4 z-60 font-sans flex flex-row items-start gap-4 justify-end">
        {/* Popup Window Menu */}
        {isOpen && (
          <div className="bg-zinc-950 flex flex-col p-6 rounded-2xl animate-in fade-in slide-in-from-right-4 duration-200 min-w-50">
