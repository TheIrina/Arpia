        ...
        <article ref={containerRef} className="space-y-12 font-['Helvetica_Neue',Helvetica,Arial,sans-serif] text-white">
            <header className="border-b border-gray-800 pb-8 mb-12">
                ...
                <p className="text-gray-400 text-sm max-w-2xl leading-relaxed">
                    La Plataforma ARPÍA informa a los Usuarios sobre el uso de cookies y tecnologías similares, esenciales para asegurar la operatividad óptima del servicio, realizar el análisis de la actividad de navegación y personalizar la experiencia del Usuario.
                </p>
            </header>
            ...
            <section className="group">
                ...
                <div className="text-gray-400 text-sm leading-relaxed space-y-4">
                    ...
                    <ul className="space-y-4">
                        <li><strong className="text-white font-medium">Cookies Estrictamente Necesarias (Técnicas):</strong> Son esenciales para el correcto funcionamiento de la Plataforma y permiten al Usuario la navegación a través de la misma y la utilización de las diferentes opciones o servicios que en ella existen. Por ejemplo, se usan para controlar el tráfico y la comunicación de datos, identificar la sesión o recordar los elementos que integran una solicitud de información.</li>
                        <li><strong className="text-white font-medium">Cookies de Personalización:</strong> Permiten al Usuario acceder al servicio con algunas características de carácter general predefinidas en función de una serie de criterios en el terminal del Usuario, como por ejemplo, el idioma o la configuración regional desde donde accede al servicio.</li>
                        <li><strong className="text-white font-medium">Cookies de Análisis:</strong> Permiten al responsable de las mismas el seguimiento y análisis del comportamiento de los Usuarios de los sitios web a los que están vinculadas. La información recogida se utiliza en la medición de la actividad de los sitios web, aplicación o plataforma y para la elaboración de perfiles de navegación de los Usuarios de dichos sitios, con el fin de introducir mejoras en función del análisis de los datos de uso que hacen los Usuarios del servicio.</li>
                        <li><strong className="text-white font-medium">Cookies de Terceros:</strong> ARPÍA puede utilizar servicios de terceros que recopilarán información con fines estadísticos, de uso de la Plataforma por parte del Usuario y para la prestación de otros servicios relacionados con la actividad del sitio web.</li>
                    </ul>
                </div>
            </section>
