  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 md:grid-cols-8 lg:grid-cols-12 gap-x-4">
        ...
        <div className="col-span-2 lg:col-start-1 lg:col-span-4 text-2xl md:text-3xl lg:text-4xl font-normal leading-[1.05] tracking-tighter font-sans">
          About us
        </div>
        ...
        {/* Learn more link */}
        <div className="col-span-2 md:col-span-8 lg:col-start-5 lg:col-span-8 mt-8">
          <button className="text-lg font-medium underline underline-offset-4 opacity-20 hover:opacity-100 transition-opacity">
            Learn more
          </button>
        </div>

        {/* Two squares below the text */}
        <div className="col-span-1 md:col-span-4 lg:col-start-5 lg:col-span-4 aspect-square bg-[#1A1A1A] rounded-2xl relative overflow-hidden mt-12 lg:mt-24">
          <Image
            src="/logo/para.avif"
        ...
        <div className="col-span-1 md:col-span-4 lg:col-span-4 aspect-square bg-[#1A1A1A] rounded-2xl relative overflow-hidden mt-12 lg:mt-24">
          <Image
            src="/logo/para.avif"
      ...
      <div className="grid grid-cols-1 md:grid-cols-8 lg:grid-cols-12 gap-x-4">
        ...
        {/* Image is placed below the text, aligned with it (start at col 5) */}
        <div className="col-span-1 md:col-span-8 lg:col-start-5 lg:col-span-8 h-[40vh] lg:h-[50vh] bg-[#1A1A1A] rounded-2xl relative overflow-hidden mt-12 lg:mt-24">
          <Image
            src="/logo/clo.avif"
            alt="Local community"
            fill
