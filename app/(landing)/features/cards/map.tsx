export function MapCardVisual() {
  return (
    <div className="relative w-full h-100 md:h-125 lg:h-150 rounded-2xl bg-[#fbfbfb] overflow-hidden flex items-center justify-center border border-gray-200">
      ...
      {/* Clima (Sol/Nube) */}
      <div
        className="absolute top-[15%] left-[20%] bg-white p-3 md:p-4 rounded-2xl border border-gray-200 text-2xl md:text-3xl flex items-center justify-center
      ...
      {/* Comida / Restaurantes */}
      <div
        className="absolute bottom-[25%] left-[20%] bg-white p-3 md:p-4 rounded-2xl border border-gray-200 text-2xl md:text-3xl flex items-center justify-center
                      after:absolute after:content-[''] after:w-4 after:h-4 after:bg-white after:border-r after:border-b after:border-gray-200 after:rotate-45 after:-bottom-2 after:left-1/2 after:-translate-x-1/2 after:rounded-sm"
      >
        🍔
      </div>
      ...
      <div
        className="absolute top-[25%] right-[25%] bg-white p-3 md:p-4 rounded-2xl border border-gray-200 text-2xl md:text-3xl flex items-center justify-center
                      after:absolute after:content-[''] after:w-4 after:h-4 after:bg-white after:border-r after:border-b after:border-gray-200 after:rotate-45 after:-bottom-2 after:left-1/2 after:-translate-x-1/2 after:rounded-sm"
      >
        🪂
      </div>
      ...
      {/* Calendario / Evento */}
      <div
        className="absolute bottom-[30%] right-[15%] bg-white p-3 md:p-4 rounded-2xl border border-gray-200 text-2xl md:text-3xl flex items-center justify-center
                      after:absolute after:content-[''] after:w-4 after:h-4 after:bg-white after:border-r after:border-b after:border-gray-200 after:rotate-45 after:-bottom-2 after:left-1/2 after:-translate-x-1/2 after:rounded-sm"
      >
        📆
      </div>
      ...
      <div
        className="absolute top-[60%] left-[10%] bg-white p-2.5 md:p-3.5 rounded-2xl border border-gray-200 text-xl md:text-2xl flex items-center justify-center
