    ...
    <>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="relative">
            <input
              ...
              placeholder="••••••••"
              minLength={8}
              className={`w-full rounded-xl border bg-[#FDFDFD] px-4 py-3 pr-12 text-sm text-[#1A1A1A] placeholder:text-black/25 outline-none focus:bg-white transition-all duration-200 ${
        ...
        <label
          ...
          className="flex items-start gap-3 cursor-pointer group mt-2"
        >
          <div className="relative mt-0.5 shrink-0">
            ...
            />
            <div className="w-4.5 h-4.5 rounded border border-black/15 bg-[#FDFDFD] peer-checked:bg-[#1A1A1A] peer-checked:border-[#1A1A1A] transition-all duration-200 flex items-center justify-center">
              {agreed && (
                <svg
        ...
        <button
          ...
          className="mt-4 w-full rounded-full bg-[#1A1A1A] text-white font-medium py-3.5 text-sm hover:bg-black disabled:opacity-30 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center gap-2"
        >
          {isLoading ? (
